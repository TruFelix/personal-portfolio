...
export default async function MusicLayout({ children }: React.PropsWithChildren) {
	...
	return <>
		{children}
		<footer className="flex justify-center pb-10 p-3 px-6 md:px-16 py-6 md:pt-10 bg-zinc-400 dark:bg-zinc-300 h-100px w-full text-stone-300 inset-shadow-neutral-50">
