...
export default async function MusicPortfolio({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const collections: Collection[] = [
    {
      ...
      years: "2023-2025",
      characteristics: [tC("personal"), tC("pads"), tC("synths"), tC("samples")],
      songs: [
    ...
    },
    {
      ...
      title: "debris",
      years: "2023-2026",
      characteristics: [tC("80s"), tC("lush"), tC("hollow")],
  ...
  return (
    <div className="flex justify-center min-h-screen bg-zinc-50 font-sans dark:bg-black">
      <main className="grid w-full content-start justify-center max-w-3xl min-h-screen md:px-16 py-3 px-4 bg-white dark:bg-black">
        ...
        <Collections className="max-w-2xl" collections={collections} />
      </main>
    </div>
  );
}